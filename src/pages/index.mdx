...
I've created a few logos for open source projects like [Git](https://git-scm.com), [Neovim](https://neovim.io/), [tmux](https://github.com/tmux/tmux/wiki), [Vitess](https://vitess.io/), and [Neki](https://neki.dev).

These are a few of the open source projects I've worked on: [[My GitHub profile](https://github.com/jasonlong)]

- <GitHubProject
    name='octodot'
    description='macOS menubar app for GitHub notifications'
...
I live in Columbus, Ohio and I'm married with three children. Two are out of college and the other is <Age birthdate="2015-09-03" /> years old. I have a degree in Computer Science from Ohio State and I started my career as a Windows developer. I worked with PHP, ASP, and Java before getting into Rails while freelancing in the early 00's. During this time, my interests shifted towards design.
...
[Bluesky](https://bsky.app/profile/jasonlong.me) <span class='separator'>|</span> [GitHub](https://github.com/jasonlong) <span class='separator'>|</span> [Are.na](https://www.are.na/jason-long-wwkm0r1awty/) <span class='separator'>|</span>
[Hardcover](https://hardcover.app/@jasonlong) <span class='separator'>|</span> <a href='mailto:jason@jasonlong.me'>Email</a>
